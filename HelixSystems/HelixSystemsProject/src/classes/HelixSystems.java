...
public class HelixSystems {
	...
	public HelixSystems(String hostname, String os, String kernel, String ip_clusternet, String ip_helixnet,
	...
	public String toString(){
		return getHostname() + " " + getOs() + " " + getKernel() + " " + getIp_clusternet() + " " + getIp_helixnet() + " " + getRepos() + " " + 
			   getGpfs_configured() + " " + getGpfs_mounted() + " " + getUpdate_packages() + " " + getSecurity_packages() + " " + getLast_boot() +
			   " " + getLast_checkin() + " " + getLast_yum_update() + " " + getHosttype() + " " + getVirt_guests() + " " + getUpdate_exception(); 
	}
}
